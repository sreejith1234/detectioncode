            ...
            if det is not None and len(det):
                ...
                if len(outputs) > 0:
                    for j, (output, conf) in enumerate(zip(outputs, confs)): 
                        ...
                        if id == 7:
                        	pass
                        elif direction_line_red == LEFT and direction_line_green == BOTTOM:  #RED
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='video/from_right.mp4', help='source')# file/folder, 0 for webcam
